...
export const PERSONAS = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { h:4,  lat:40.7072, lng:-74.0050, loc:'Home — TriBeCa',           borough:1, desc:'Coffee, gear, out before 5. Delivery trucks on every block. The kitchen before the kitchen opens.' },
      { h:5,  lat:40.7150, lng:-74.0020, loc:'Walking to Job Site',      borough:1, desc:'Two miles north on foot. Just him and the trucks in the dark.' },
      ...
      { h:17, lat:40.7200, lng:-73.9990, loc:'Walking Home',             borough:1, desc:'South on the sidewalk. Walking opposite the commuter flow.' },
      { h:18, lat:40.7072, lng:-74.0050, loc:'Home — TriBeCa',           borough:1, desc:'Home. Kids on the block, the evening starting up.' },
      ...
      { h:21, lat:40.7072, lng:-74.0050, loc:'Home — TriBeCa',           borough:1, desc:'Asleep.' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { h:7,  lat:40.7780, lng:-73.9560, loc:'East River Esplanade',     borough:1, desc:'Morning walk. The esplanade belongs to the dogs before it belongs to anyone else.' },
