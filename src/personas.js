...
export const PERSONAS = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { h:2,  lat:40.7265, lng:-73.9862, loc:'East Village — Pickup',    borough:1, desc:'Picking up a drunk couple from a dive bar in East Village. One of them almost vomited in the back seat, but thankfully didn\'t.' },
      { h:3,  lat:40.7100, lng:-74.0050, loc:'Lower Manhattan',          borough:1, desc:'Long stretches with no one in the back seat. The night is slowing down. Just going through the motions. She put on her favorite Britney song.' },
      { h:4,  lat:40.7072, lng:-74.0050, loc:'Financial District — Last Fares',     borough:1, desc:'Almost nothing left to pick up. The night shift is almost over. She\'s almost home.' },
      { h:5,  lat:40.7360, lng:-74.0010, loc:'Heading Home',             borough:1, desc:'Last run north. Just her own engine sound rumbling. Almost there!' },
      { h:6,  lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'Long night. People going to work just as she\'s winding down. The street eerily quiet.' },
      { h:7,  lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'Quick shower, then straight to bed. Morning traffic starts stitching the avenue back together. She sleeps through it all.' },
      { h:8,  lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'While most people start their day, she enters deep sleep.' },
      { h:9,  lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'Asleep.' },
      { h:10, lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'Even woofs cannot wake her up.' },
      { h:11, lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'Sleeping. Don\'t worry my friends, we\'ll see some action very soon!.' },
      { h:12, lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'We hear some birds! Still sleeping btw. She had a long night!' },
      { h:13, lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'Zzzzzz.' },
      { h:14, lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'This engine noise is really reminding her of work. She woke up before her alarm. Facetimed her partner.' },
      { h:15, lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'She can feel her shift coming. The woofies are getting louder.' },
      { h:16, lat:40.7592, lng:-73.9982, loc:'Home — Hell\'s Kitchen',   borough:1, desc:'It\'s 4pm. Time to hit the streets. The crowd is starting to gather.' },
      { h:17, lat:40.7592, lng:-73.9982, loc:'Hell\'s Kitchen — Prepping',borough:1, desc:'Out for food. The trumpets are gonna carry her back into the machine.' },
      { h:18, lat:40.7550, lng:-73.9850, loc:'Broadway — Early Shift',    borough:1, desc:'Shift starts. Theater crowd. She\'s playing them songs from Wicked. Unliiiiiiiiimiteeeeedddd 🧹✨🧙‍♀️🧹✨' },
      { h:19, lat:40.7480, lng:-73.9890, loc:'Times Square — Working',   borough:1, desc:'Shows letting out, bars opening. Countless of small talks that rarely lead anywhere.' },
      { h:20, lat:40.7380, lng:-74.0020, loc:'West Village — Working',   borough:1, desc:'West Village restaurant crowd. Good fares, short rides. They tip well, and not too chatty. Nadia likes that.' },
      { h:21, lat:40.7308, lng:-74.0002, loc:'Greenwich Village — Working',       borough:1, desc:'The backseat is getting rowdy. Everyone talking at once. The whole city talking at once. Nadia also likes that.' },
      { h:22, lat:40.7265, lng:-73.9862, loc:'East Village — Working',   borough:1, desc:'Getting to the fun part of the night. Most restaurants are closed, but people are still going out to dance. ' },
      { h:23, lat:40.7480, lng:-73.9890, loc:'Herald Square — Late',     borough:1, desc:'Approaching midnight. Somehow not a lot of customers at this hour. She hasn\'t talked to anyone in almost 30 minutes. She\'s jamming along to Shania Twain, so no fret.' },
    ]
  },
]
