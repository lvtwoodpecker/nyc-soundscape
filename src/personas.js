...
export const PERSONAS = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { h:14, lat:40.7300, lng:-73.9990, loc:'Job Site',                 borough:1, desc:'Werk werk werk.' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { h:10, lat:40.7290, lng:-73.9976, loc:'Silver Center — NYU',      borough:1, desc:'Class prep. The drill still going. The students have stopped noticing it.' },
      ...
      { h:14, lat:40.7480, lng:-73.9890, loc:'Midtown — Field Recording',borough:1, desc:'Subway uptown with a recorder and a notebook. Field recording for his Music Tech class.' },
      { h:15, lat:40.7592, lng:-73.9982, loc:'Hell\'s Kitchen — Street', borough:1, desc:'Mic out, levels set. Crosswalk chirps, HVAC, delivery trucks. The city as a signal.' },
      { h:16, lat:40.7592, lng:-73.9982, loc:'Hell\'s Kitchen — Street', borough:1, desc:'He records a garbage truck for twelve minutes. Not for the story, for the spectrum.' },
      ...
      { h:21, lat:40.7763, lng:-73.9637, loc:'Home — Upper East Side',   borough:1, desc:'Reading. Right now the whole city is at its loudest — the number he keeps citing in class. He closes the window.' },
