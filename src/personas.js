...
export const PERSONAS = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { h:2,  lat:40.7265, lng:-73.9862, loc:'Home — East Village',      borough:1, desc:'Home. Asleep by 2:30. The good kind of asleep, despite all that noise.' },
      ...
      { h:7,  lat:40.7265, lng:-73.9862, loc:'Home — East Village',      borough:1, desc:'Asleep. Alarm set for noon. A saw starts up somewhere. Somehow she sleeps even better. Dreaming about that day she stumbled upon Dog Mode on the NYC Soundscape website, and how soothing that was.' },
      { h:8,  lat:40.7265, lng:-73.9862, loc:'Home — East Village',      borough:1, desc:'Asleep while the morning floods the streets.' },
      { h:9,  lat:40.7265, lng:-73.9862, loc:'Home — East Village',      borough:1, desc:'Still asleep. Still dreaming. No classes today! And a big performance! Woof woof!' },
      { h:10, lat:40.7265, lng:-73.9862, loc:'Home — East Village',      borough:1, desc:'ZZzzzZZzzZZZZzzzz.' },
      ...
      { h:12, lat:40.7265, lng:-73.9862, loc:'Home — East Village',      borough:1, desc:'Up. Morning routine. Vocal exercises at the window. The rumbling outside is her backing band. Big day today!' },
      { h:13, lat:40.7290, lng:-73.9900, loc:'East Village — Walk',      borough:1, desc:'Coffee shop and a casual walk. The street\'s loud today. She\'s taking it all in. Ahh... New York City. She\'s like that meme of someone romanticizing New York City like it\'s Tokyo.' },
      ...
      { h:22, lat:40.7348, lng:-74.0026, loc:'Village Vanguard',         borough:1, desc:'Last song... standing ovation... loud music starts playing to chase out the crowd. SONYC sensors finally picked up some sounds from the venue!' },
